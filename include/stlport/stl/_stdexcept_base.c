...
#ifndef __Named_exception_inline
#define __Named_exception_inline
#endif
	
__Named_exception_inline __Named_exception::__Named_exception(const string& __str) {
...
__Named_exception_inline __Named_exception::__Named_exception(const __Named_exception& __x) {
...
__Named_exception_inline __Named_exception& __Named_exception::operator = (const __Named_exception& __x) {
  size_t __size = strlen(__x._M_name) + 1;
...
__Named_exception_inline __Named_exception::~__Named_exception() _STLP_NOTHROW_INHERENTLY {
  if (_M_name != _M_static_name)
    free(_M_name);
}

__Named_exception_inline   const char* __Named_exception::what() const _STLP_NOTHROW_INHERENTLY
{ return _M_name; }
